...
import { Cohort, FilterOption } from 'src/app/models/class/cohort.model';
...
import { AddCohortDialogComponent } from 'src/app/components/cohort-components/add-cohort-dialog-component/add-cohort-dialog-component.component';
@Component({
  selector: 'app-cohort',
  standalone: true,
  imports: [
